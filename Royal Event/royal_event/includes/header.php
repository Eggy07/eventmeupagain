          ...
          { 
            ...
            <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              ...
              <?php 
                  ...
                  $imagePath = "assets/img/avatars/" . $row->Photo;
                  if (!empty($row->Photo) && file_exists($imagePath)) { 
                ?>
                    <img class="img-avatar" src="<?php echo $imagePath; ?>" alt="User Avatar">
                <?php 
                  } else { 
                ?>
                    <img class="img-avatar" src="assets/img/avatars/pro4.jpg" alt="Default Avatar">
                <?php 
                  } 
                ?>
                </div>
  ...
  <div class="navbar-menu-wrapper d-flex align-items-stretch w-100">
    ...
    <ul class="navbar-nav navbar-nav-left">
        ...
        {  
         ...
         <li class="nav-item">
            <a class="nav-link" target="_blank" href="https://www.facebook.com/kent.vincent20">
